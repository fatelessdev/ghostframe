...
// 🎯 Why: Prevent recreating objects/arrays on every render, preserving referential equality
// 📊 Impact: Significantly reduces re-renders of the expensive Streamdown component
