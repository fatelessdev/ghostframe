...
import { XIcon, PowerIcon, MessagesSquareIcon } from "lucide-react";
    ...
    <div className="flex flex-row w-full h-full bg-black/60 text-white rounded-2xl overflow-hidden relative pointer-events-auto border border-white/10 shadow-2xl backdrop-blur-md">
      ...
      <div className="flex flex-col w-56 flex-shrink-0 border-r border-white/10 bg-black/20">
        ...
        <div className="p-3 border-t border-white/10 space-y-1">
          <button
            onClick={() => invoke("open_dashboard", { path: "/chats" })}
            className="w-full text-left px-3 py-2 text-sm font-medium rounded-lg transition-all text-white/50 hover:text-white hover:bg-white/5 flex items-center gap-2"
          >
