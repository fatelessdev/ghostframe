...
// 🎯 Why: This component renders a potentially large list of transcript segments.
// 📊 Impact: Prevents wasteful re-renders of the list sub-tree when unrelated parent state changes.
