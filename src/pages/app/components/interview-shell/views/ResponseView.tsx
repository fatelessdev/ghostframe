...
// 🎯 Why: Prevent re-rendering heavy Markdown child component when unrelated state changes in parent
// 📊 Impact: Prevents wasteful parent re-renders propagating down to the expensive Streamdown render tree
