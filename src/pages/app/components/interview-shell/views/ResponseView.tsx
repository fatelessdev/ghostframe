...
// 🎯 Why: Shields the expensive Markdown sub-tree from wasteful re-renders triggered by unrelated state updates in parent components (e.g., OverlayPanel or InterviewShell)
// 📊 Impact: Significantly improves rendering performance of the overlay panel by avoiding recalculations of Markdown when props are unchanged
